...
resource "azurerm_network_security_group" "deploy1"{
    ...
    source_port_range          = "*"
    destination_address_prefix = "${var.subnet1-address}"
    ...
    protocol                   = "Tcp"
    source_address_prefix    = "${var.Management-JumpBox_Subnet_AddressPrefix}"
    source_port_range          = "*"
    destination_address_prefix = "${var.subnet1-address}"
    ...
    protocol                   = "Tcp"
    source_address_prefix    = "${var.subnet2-address}"
  ...
  security_rule {
    ...
    protocol                   = "Tcp"
    source_address_prefix    = "${var.subnet1-address}"
    source_port_range          = "*"
    destination_address_prefix = "${var.subnet3-address}"
  ...
  security_rule {
    ...
    destination_address_prefix = "${var.subnet2-address}"
...
security_rule {
  ...
  security_rule {
    ...
    protocol                   = "Tcp"
    source_address_prefix    = "${var.subnet3-address}"
    source_port_range          = "*"
    destination_address_prefix = "${var.subnet2-address}"
...
resource "azurerm_network_security_group" "deploy4"{
    ...
    source_address_prefix    = "*"
    source_port_range          = "*"
    destination_address_prefix = "${var.subnet1-address-replica}"
    destination_port_ranges    = ["80","443"]
    priority                   =  100
    direction                  = "Inbound"
    access                     = "Allow"  
    ...
    name                       = "SSHandRDP-to-WEB"
    protocol                   = "Tcp"
    source_address_prefix    = "${var.Management-JumpBox_Subnet_AddressPrefix-Replica}"
    source_port_range          = "*"
    destination_address_prefix = "${var.subnet1-address-replica}"
    destination_port_ranges    = ["22","3389"]
    priority                   =  110
    ...
    name                       = "API-Web-response"
    protocol                   = "Tcp"
    source_address_prefix    = "${var.subnet2-address-replica}"
    source_port_range          = "8083"
    destination_address_prefix = "${var.subnet1-address-replica}"
    destination_port_range    = "8081"
    priority                   =  120
  ...
  security_rule {
    name                       = "DenyOutBoundToDB"
    protocol                   = "Tcp"
    source_address_prefix    = "${var.subnet1-address-replica}"
    source_port_range          = "*"
    destination_address_prefix = "${var.subnet3-address-replica}"
    destination_port_range    = "*"
    priority                   =  100
    direction                  = "Outbound"
    access                     = "Deny"  
  ...
  security_rule {
    ...
    source_address_prefix    = "${var.subnet1-address-replica}"
    source_port_range          = "8081"
    destination_address_prefix = "${var.subnet2-address-replica}"
    destination_port_range    = "8083"
    priority                   =  110
    direction                  = "Outbound"
    access                     = "Allow"  
...
security_rule {
  ...
  security_rule {
    name                       = "FTPfromDB-to-API"
    protocol                   = "Tcp"
    source_address_prefix   = "${var.subnet3-address-replica}"
    source_port_range          = "*"
    destination_address_prefix = "${var.subnet2-address-replica}"
    destination_port_range    = "21"
    priority                   =  120
