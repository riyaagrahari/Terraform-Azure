...
$ResourceGroup1="RG1"
$ResourceGroup2="RG1-replica"
$port=2800

$inboundRule1="Inbound-ReplicaDB-PrimaryDB"
$outboundRule1="Outbound-PrimaryDB-ReplicaDB"
$inboundRule2="Inbound-PrimaryDB-ReplicaDB"
$outboundRule2="Outbound-ReplicaDB-PrimaryDB"
